...
set.seed(1405)
# low MR
net_low <- make_diagnostics_net(N_ind, low = T)

# medium MR
net_medium <- make_diagnostics_net(N_ind, medium = T)

# high MR
net_high <- make_diagnostics_net(N_ind, high = T)
